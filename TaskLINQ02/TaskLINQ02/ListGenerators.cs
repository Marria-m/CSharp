...
namespace TaskLINQ02
{
    ...
    class Customer
    {
        ...
        public override string ToString()
            => $"{Id}, {Name}, {Address}, {City}, {City}, {PostalCode}, {Country}, {Phone}, {Fax}";
    }
    class Order
    {
        public int Id { get; set; }
        ...
        public override string ToString()
            => $"Order Id: {Id}, Date: {OrderDate.ToShortDateString()}, Total: {Total}";
    }
    internal static class ListGenerators
    {
        ...
        static ListGenerators()
        {
                 ...
                 new Customer
            {
                ...
                Orders = new Order[]
                {
                    new Order { Id = 10643, OrderDate = new DateTime(1997, 8, 25), Total = 814.50 },
                    new Order { Id = 10692, OrderDate = new DateTime(1997, 10, 3), Total = 878.00 },
                    new Order { Id = 10702, OrderDate = new DateTime(1997, 10, 13), Total = 330.00 },
                    new Order { Id = 10835, OrderDate = new DateTime(1998, 1, 15), Total = 845.80 },
                    new Order { Id = 10952, OrderDate = new DateTime(1998, 3, 16), Total = 471.20 },
